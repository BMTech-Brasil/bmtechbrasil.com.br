        ...
        <div class="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div class="flex items-center gap-4">
              <a href="https://www.linkedin.com/in/bmtech-brasil-b8370b2bb/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-[#0a66c2] transition-colors duration-300" title="Siga a BM Tech no LinkedIn">
              ...
              <a href="https://www.instagram.com/bmtechbrasil/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-[#E1306C] transition-colors duration-300" title="Siga a BM Tech no Instagram">
              ...
              <a href="https://www.tiktok.com/@bmtechbrasil" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-black transition-colors duration-300" title="Siga a BM Tech no TikTok">
